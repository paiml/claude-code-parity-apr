...
help:
	...
	@echo "  make pin-check-roundtrip companion ↔ aprender bytes round-trip          (M22 drift guard)"
	@echo "  make check-doc-drift    spec/README/CONTRIBUTING M-count/version drift  (M22 step 4 backstop)"
	@echo "  make test-doc-drift     meta-test for check-doc-drift                  (M46)"
	@echo "  make parity             ccpa corpus canonical/ + regression/           (FALSIFY-CCPA-008/013)"
	@echo "  make mutants            cargo mutants on ccpa-differ                  (mutation coverage)"
	@echo
